...
100 % autónomo desde v17: librerías de exporte y fuente incrustadas, cero peticiones de red.

- Usar: abre `dist/simulador_capsulas_sst_v17.html` en Google Chrome o Microsoft Edge. Todo funciona sin conexión;
