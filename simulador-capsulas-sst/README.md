...
IPEVR (GTC 45:2012) y FURAT diligenciado por voz que se entrega en la plantilla oficial (.xlsx, formato F 2015 - PR v3), PDF y JSON. Un solo archivo HTML sin backend,
...
- Usar: abre `dist/simulador_capsulas_sst_v20.html` en Google Chrome o Microsoft Edge. Todo funciona sin conexión;
