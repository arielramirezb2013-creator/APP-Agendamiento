...
| Archivo | Contenido |
|---|---|
| `Rehavid_Gestion_Proyectos_v14.html` | La aplicación (un solo archivo; interfaz estilo Jira Premium con tablero kanban, lista y calendario; los usuarios son los ocho cargos). |
