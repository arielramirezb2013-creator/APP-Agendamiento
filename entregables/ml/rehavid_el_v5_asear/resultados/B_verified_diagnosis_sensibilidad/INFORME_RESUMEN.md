...
Carpeta de ejecución: `/tmp/claude-0/-home-user-APP-Agendamiento/a0122bb2-9092-5cf7-890f-1196c801245f/scratchpad/rehavid/asear_trabajo/ejecucion_20260916T215737Z_consolidados_verified_diagnosis`  
Fecha (UTC): 2026-09-16T22:02:28+00:00  
Diseño de vínculos: consolidados (consolidados = B principal; contratos = A sensibilidad)  
Disponibilidad de antecedentes: inicial  
Sensibilidad: verified_diagnosis  
...
|---|---|---|---|---|---|---|---|---|---|---|
| train | 12 | 260 | <5 | <5 | 198 | 60 | 884 | 365 | potentially_evaluable |  |
| train | 36 | 260 | <5 | <5 | 0 | 257 | 884 | 1096 | insufficient_support | seguimiento posterior al horizonte insuficiente |
| train | 60 | 260 | <5 | <5 | 0 | 257 | 884 | 1826 | insufficient_support | seguimiento posterior al horizonte insuficiente |
| validation | 12 | 85 | 0 | 0 | 70 | 15 | 884 | 365 | insufficient_support | pocos eventos observados al horizonte |
| validation | 36 | 85 | 0 | 0 | 0 | 85 | 884 | 1096 | insufficient_support | pocos eventos observados al horizonte; seguimiento posterior al horizonte insuficiente |
| validation | 60 | 85 | 0 | 0 | 0 | 85 | 884 | 1826 | insufficient_support | pocos eventos observados al horizonte; seguimiento posterior al horizonte insuficiente |
| test | 12 | 92 | 0 | 0 | 71 | 21 | 884 | 365 | insufficient_support | pocos eventos observados al horizonte |
| test | 36 | 92 | 0 | 0 | 0 | 92 | 884 | 1096 | insufficient_support | pocos eventos observados al horizonte; seguimiento posterior al horizonte insuficiente |
| test | 60 | 92 | 0 | 0 | 0 | 92 | 884 | 1826 | insufficient_support | pocos eventos observados al horizonte; seguimiento posterior al horizonte insuficiente |
...
|---|---|---|---|---|---|
| train | False | 257 | 884 | 81 | 884 |
| train | True | <5 | suprimido | suprimido | suprimido |
| validation | False | 85 | 884 | 248 | 884 |
| test | False | 92 | 884 | 200 | 884 |
...
| score | tenure_years | 3536 | 0 | 0 |
| score | health_available_ausentismo_comun_3m | 3536 | 0 | 0 |
| score | health_count_ausentismo_comun_3m | 3536 | 257 | 7.268099547511313 |
| score | health_days_ausentismo_comun_3m | 3536 | 257 | 7.268099547511313 |
| score | health_available_ausentismo_laboral_3m | 3536 | 0 | 0 |
| score | health_count_ausentismo_laboral_3m | 3536 | 257 | 7.268099547511313 |
| score | health_days_ausentismo_laboral_3m | 3536 | 257 | 7.268099547511313 |
| score | health_available_at_3m | 3536 | 0 | 0 |
| score | health_count_at_3m | 3536 | 3536 | 100 |
| score | health_days_at_3m | 3536 | 3536 | 100 |
| score | health_available_veo_3m | 3536 | 0 | 0 |
| score | health_count_veo_3m | 3536 | 3536 | 100 |
| score | health_days_veo_3m | 3536 | 3536 | 100 |
| score | health_available_ausentismo_comun_6m | 3536 | 0 | 0 |
| score | health_count_ausentismo_comun_6m | 3536 | 1244 | 35.18099547511312 |
| score | health_days_ausentismo_comun_6m | 3536 | 1244 | 35.18099547511312 |
| score | health_available_ausentismo_laboral_6m | 3536 | 0 | 0 |
| score | health_count_ausentismo_laboral_6m | 3536 | 1244 | 35.18099547511312 |
| score | health_days_ausentismo_laboral_6m | 3536 | 1244 | 35.18099547511312 |
| score | health_available_at_6m | 3536 | 0 | 0 |
| score | health_count_at_6m | 3536 | 3536 | 100 |
| score | health_days_at_6m | 3536 | 3536 | 100 |
| score | health_available_veo_6m | 3536 | 0 | 0 |
| score | health_count_veo_6m | 3536 | 3536 | 100 |
| score | health_days_veo_6m | 3536 | 3536 | 100 |
| score | health_available_ausentismo_comun_12m | 3536 | 0 | 0 |
| score | health_count_ausentismo_comun_12m | 3536 | 1875 | 53.02601809954752 |
| score | health_days_ausentismo_comun_12m | 3536 | 1875 | 53.02601809954752 |
| score | health_available_ausentismo_laboral_12m | 3536 | 0 | 0 |
| score | health_count_ausentismo_laboral_12m | 3536 | 1875 | 53.02601809954752 |
| score | health_days_ausentismo_laboral_12m | 3536 | 1875 | 53.02601809954752 |
| score | health_available_at_12m | 3536 | 0 | 0 |
| score | health_count_at_12m | 3536 | 3536 | 100 |
| score | health_days_at_12m | 3536 | 3536 | 100 |
| score | health_available_veo_12m | 3536 | 0 | 0 |
| score | health_count_veo_12m | 3536 | 3536 | 100 |
| score | health_days_veo_12m | 3536 | 3536 | 100 |
...
```json
{
  ...
  "validation_metrics": [],
  "paths": {
    "candidate_validation": "/tmp/claude-0/-home-user-APP-Agendamiento/a0122bb2-9092-5cf7-890f-1196c801245f/scratchpad/rehavid/asear_trabajo/ejecucion_20260916T215737Z_consolidados_verified_diagnosis/resultado/analisis/tables/candidate_validation.csv",
    "candidate_status": "/tmp/claude-0/-home-user-APP-Agendamiento/a0122bb2-9092-5cf7-890f-1196c801245f/scratchpad/rehavid/asear_trabajo/ejecucion_20260916T215737Z_consolidados_verified_diagnosis/resultado/analisis/tables/candidate_status.csv",
    "test_metrics": "/tmp/claude-0/-home-user-APP-Agendamiento/a0122bb2-9092-5cf7-890f-1196c801245f/scratchpad/rehavid/asear_trabajo/ejecucion_20260916T215737Z_consolidados_verified_diagnosis/resultado/analisis/tables/test_metrics.csv",
    "calibration": "/tmp/claude-0/-home-user-APP-Agendamiento/a0122bb2-9092-5cf7-890f-1196c801245f/scratchpad/rehavid/asear_trabajo/ejecucion_20260916T215737Z_consolidados_verified_diagnosis/resultado/analisis/tables/calibration.csv",
    "decision_curve": "/tmp/claude-0/-home-user-APP-Agendamiento/a0122bb2-9092-5cf7-890f-1196c801245f/scratchpad/rehavid/asear_trabajo/ejecucion_20260916T215737Z_consolidados_verified_diagnosis/resultado/analisis/tables/decision_curve.csv",
    "horizon_status": "/tmp/claude-0/-home-user-APP-Agendamiento/a0122bb2-9092-5cf7-890f-1196c801245f/scratchpad/rehavid/asear_trabajo/ejecucion_20260916T215737Z_consolidados_verified_diagnosis/resultado/analisis/tables/horizon_status.csv",
    "predictions": "/tmp/claude-0/-home-user-APP-Agendamiento/a0122bb2-9092-5cf7-890f-1196c801245f/scratchpad/rehavid/asear_trabajo/ejecucion_20260916T215737Z_consolidados_verified_diagnosis/resultado/analisis/tables/predictions.csv",
    "group_predictions": "/tmp/claude-0/-home-user-APP-Agendamiento/a0122bb2-9092-5cf7-890f-1196c801245f/scratchpad/rehavid/asear_trabajo/ejecucion_20260916T215737Z_consolidados_verified_diagnosis/resultado/analisis/tables/group_predictions.csv",
    "metadata": "/tmp/claude-0/-home-user-APP-Agendamiento/a0122bb2-9092-5cf7-890f-1196c801245f/scratchpad/rehavid/asear_trabajo/ejecucion_20260916T215737Z_consolidados_verified_diagnosis/resultado/analisis/models/model_metadata.json"
  },
  "limitations": [
...
| motivo_12m | n |
|---|---|
| Cohorte de entrenamiento inferior al mínimo informático de eventos. | 3536 |
...
| validation_scope | n |
|---|---|
| internal_independent_person_holdout | 3536 |
...
| outcomes | schema_read | — | 10 | fbd6562b648402174969b43bb3a05d9f06ced20a0f0c57b67b3963da95bb7bb5 |
...
| --- | --- | --- | --- | --- | --- |
| Entrenamiento | False | 257 | 884 | 81 | 884 |
| Entrenamiento | True | <5 | Suprimido | Suprimido | Suprimido |
| Validación | False | 85 | 884 | 248 | 884 |
| Prueba | False | 92 | 884 | 200 | 884 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Entrenamiento | 12 | 260 | <5 | <5 | 198 | 60 | 884 | 365 | Potencialmente evaluable |  |
| Entrenamiento | 36 | 260 | <5 | <5 | 0 | 257 | 884 | 1096 | Soporte insuficiente | seguimiento posterior al horizonte insuficiente |
| Entrenamiento | 60 | 260 | <5 | <5 | 0 | 257 | 884 | 1826 | Soporte insuficiente | seguimiento posterior al horizonte insuficiente |
| Validación | 12 | 85 | 0 | 0 | 70 | 15 | 884 | 365 | Soporte insuficiente | pocos eventos observados al horizonte |
| Validación | 36 | 85 | 0 | 0 | 0 | 85 | 884 | 1096 | Soporte insuficiente | pocos eventos observados al horizonte; seguimiento posterior al horizonte insuficiente |
| Validación | 60 | 85 | 0 | 0 | 0 | 85 | 884 | 1826 | Soporte insuficiente | pocos eventos observados al horizonte; seguimiento posterior al horizonte insuficiente |
| Prueba | 12 | 92 | 0 | 0 | 71 | 21 | 884 | 365 | Soporte insuficiente | pocos eventos observados al horizonte |
| Prueba | 36 | 92 | 0 | 0 | 0 | 92 | 884 | 1096 | Soporte insuficiente | pocos eventos observados al horizonte; seguimiento posterior al horizonte insuficiente |
| Prueba | 60 | 92 | 0 | 0 | 0 | 92 | 884 | 1826 | Soporte insuficiente | pocos eventos observados al horizonte; seguimiento posterior al horizonte insuficiente |
