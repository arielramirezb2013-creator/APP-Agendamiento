# -*- coding: utf-8 -*-
"""Diagrama del proceso · Rehavid Gestión de proyectos v12.
...
# ---- título y leyenda ----
ax.text(W / 2, 2.4, "REHAVID · GESTIÓN DE PROYECTOS v12 · DIAGRAMA DEL PROCESO",
        ha="center", va="center", fontsize=15, fontweight="bold", color=MORADO)
ax.text(W / 2, 5.4, "Once pasos del flujo (especificación funcional 1.1) · qué información se ingresa, qué operación hace la herramienta y qué información sale",
