...
def hoja_instrucciones(wb, titulo, alcance, hojas_nombres):
    ...
    filas = [
      ...
      "La carga la hace un ADMINISTRADOR (por defecto CEO, Gerente, Director de Proyectos y Jefe de",
      "Operaciones; el perfil se asigna en la app: Parametrización → Perfiles y accesos):",
