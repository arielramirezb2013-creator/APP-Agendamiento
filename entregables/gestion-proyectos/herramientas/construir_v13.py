...
from contenido_v13 import MAPA, ROLES, ORDEN_ROLES, PASOS

DESTINO = "/home/user/APP-Agendamiento/entregables/gestion-proyectos/Mapa_de_usuario_y_validacion_Rehavid_v13.xlsx"
...
TITULO_GRAL = ("REHAVID S.A.S. · Gestión de proyectos v13 · Mapa de usuario y guía de validación · SEGUNDA RONDA")
PIE_FUENTE = ("Fuente: Especificación funcional y flujograma del proceso de gestión de proyectos, versión 1.1, Rehavid S.A.S. "
              "Segunda ronda de validación sobre la versión 13: usuarios por cargo, ajustes de la primera ronda aplicados; el paso 0 (guía y alimentación por bases de Excel) es nuevo en esta versión. "
...
# ============================ PESTAÑA 1 · MAPA ============================
ws = wb.active
ws.title = "Mapa de usuario"
ENC = ["Rol / cargo", "Momento del proceso (pasos 0 a 11)", "Qué hace",
...
poner_titulo(ws, NC, TITULO_GRAL,
    "Pestaña 1 · Mapa de usuario de la versión 13. Cada fila es una intervención real de un cargo en el flujo (el paso 0 de guía y alimentación por bases, y los once pasos de la especificación), "
    "incluidas las funciones nuevas: coordinación con ciclo propio, solicitud consolidada, resolución a cuatro decisiones, "
    "hitos actualizables y cierre estricto. Solo lectura: esta pestaña no se diligencia.")
FILA_ENC = 5
...
ws = wb.create_sheet(title="Diagrama del proceso", index=1)
NCD = 12
poner_titulo(ws, NCD, TITULO_GRAL,
    "Pestaña 2 · Diagrama del proceso: la alimentación por bases de Excel y los once pasos del flujo; por cada paso, qué información se ingresa, "
    "qué operación hace la herramienta y qué información sale. Solo lectura.")
for col in range(1, NCD + 1):
    ws.column_dimensions[get_column_letter(col)].width = 13
ws.row_dimensions[4].height = 8
img = XLImage("diagrama_v13.png")
# El PNG está a 200 ppp; se presenta a la mitad de sus píxeles para verse nítido y proporcionado.
import PIL.Image as _PIL
_im = _PIL.open("diagrama_v13.png")
...
# ============================ PESTAÑAS POR CARGO ============================
ENC_ROL = ["N°", "Momento del proceso", "Actividad a revisar",
...
poner_titulo(ws, NCS, TITULO_GRAL,
    "Pestaña final · Consolidación de las observaciones de la segunda ronda. El N° corresponde a la columna N° de la pestaña del cargo.")
...
modulos = ("00 Guía,01 Dashboard,02 Empresas y productos,03 Alertas,04 Mis asignaciones,05 Planes de trabajo,"
           "06 Calendario,07 Nuevo proyecto,08 Parametrización,09 Bases y auditoría,Varios módulos")
...
wb.properties.title = "Mapa de usuario y validación v13 · Rehavid · Gestión de proyectos · segunda ronda"
