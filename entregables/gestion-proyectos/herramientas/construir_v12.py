...
from contenido_v12 import MAPA, ROLES, ORDEN_ROLES, PASOS

DESTINO = "/home/user/APP-Agendamiento/entregables/gestion-proyectos/Mapa_de_usuario_y_validacion_Rehavid_v12.xlsx"
...
TITULO_GRAL = ("REHAVID S.A.S. · Gestión de proyectos v12 · Mapa de usuario y guía de validación · SEGUNDA RONDA")
PIE_FUENTE = ("Fuente: Especificación funcional y flujograma del proceso de gestión de proyectos, versión 1.1, Rehavid S.A.S. "
              "Segunda ronda de validación sobre la versión 12: usuarios por cargo, ajustes de la primera ronda aplicados. "
...
ENC = ["Rol / cargo", "Momento del proceso (pasos 1 a 11)", "Qué hace",
...
poner_titulo(ws, NC, TITULO_GRAL,
    "Pestaña 1 · Mapa de usuario de la versión 11. Cada fila es una intervención real de un cargo en el flujo de once pasos, "
...
poner_titulo(ws, NCD, TITULO_GRAL,
    "Pestaña 2 · Diagrama del proceso de once pasos: por cada paso, qué información se ingresa, "
    "qué operación hace la herramienta y qué información sale. Solo lectura.")
for col in range(1, NCD + 1):
    ws.column_dimensions[get_column_letter(col)].width = 13
ws.row_dimensions[4].height = 8
img = XLImage("diagrama_v12.png")
...
modulos = ("01 Dashboard,02 Empresas y productos,03 Alertas,04 Mis asignaciones,05 Planes de trabajo,"
...
wb.properties.title = "Mapa de usuario y validación v12 · Rehavid · Gestión de proyectos · segunda ronda"
