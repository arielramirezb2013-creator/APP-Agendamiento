...
from contenido_v16 import MAPA, ROLES, ORDEN_ROLES, PASOS

DESTINO = "/home/user/APP-Agendamiento/entregables/gestion-proyectos/Historia_de_usuario_Rehavid_v16.xlsx"
...
TITULO_GRAL = ("REHAVID S.A.S. · Gestión de proyectos v16 · VERSIÓN FINAL · aceptación de salida a producción")
PIE_FUENTE = ("Fuente: Especificación funcional y flujograma del proceso de gestión de proyectos, versión 1.1, Rehavid S.A.S. "
              "Ronda de aceptación sobre la versión 16 (final): modelo de administradores (CEO, Gerente, Director, Jefe), costos restringidos, y los hallazgos de la tercera ronda aplicados (plan con horas planificadas, coordinación bloqueante, ubicación obligatoria, reasignación entre gestores, calendario uniforme). "
...
poner_titulo(ws, NC, TITULO_GRAL,
    "Pestaña 1 · Historia de usuario de la versión 16 (final): el modelo de administradores y las intervenciones de cada "
    "cargo en las épicas del flujo. Solo lectura: esta pestaña no se diligencia.")
FILA_ENC = 5
...
wb.properties.title = "Historia de usuario v16 · Rehavid · Gestión de proyectos · versión final"
